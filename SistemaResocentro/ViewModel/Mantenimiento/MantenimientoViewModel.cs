...
namespace SistemaResocentro.ViewModel.Mantenimiento
{
    public class MantenimientoViewModel
    {
        ...
        public List<ConversacionesMantenimiento> listaConversaciones { get; set; }


        public string telefono { get; set; }
    }
    public class ConversacionesMantenimiento
    {
    ...
    public class EquipoMantenimiento
    {
        ...
        public int cant_mantenimientos { get; set; }
    }
