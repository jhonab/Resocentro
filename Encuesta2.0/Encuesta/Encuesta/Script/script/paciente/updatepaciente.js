...
function validar_paciente_update() {
    var result = true;
...
function updatePaciente() {
    if (validar_paciente_update()) {
        ...
        $.ajax({
            async: false,
            cache: false,
            url: "/Paciente/UpdatePacienteAjax",
            ...
            success: function (data) {
                if (data.result) {
                    ...
                    toastr.success('Paciente Modificado', 'Exito', opts);
                } else {
                    $("#codigopaciente").val("0"),
                    toastr.error('Error modificar paciente intentelo nuevamente', 'Error', opts);
                }
            }
        });
    }
