...
function hide_sidebar_menu(with_animation)
{
	...
	else
	{
		...
		if( ! rtl())
		{
		    TweenMax.to($collapse_icon, .5, { css: { left: 3 - padding_diff }, delay: .001 });
		}
		
		public_vars.$pageContainer.transit({paddingLeft: padding_left}, public_vars.sidebarTransitionTime+600);
