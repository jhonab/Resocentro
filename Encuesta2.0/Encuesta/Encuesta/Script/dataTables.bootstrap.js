...
jQuery.extend( true, jQuery.fn.dataTable.defaults, {
    "sDom":
        //"<'row'<'col-md-4 col-left'l><'col-md-8 col-right'f>r>t<'row'<'col-md-6 col-left'i><'col-md-6 col-right'p>>",
        "<'row'<'col-sm-4 col-left'l><'col-sm-8 col-right'f>>" +
		"<'row'<'col-sm-12'tr>>" +
		"<'row'<'col-sm-6 col-left'i><'col-sm-6 col-right'p>>",
