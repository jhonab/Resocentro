...
a.sInstance + "_" + location.pathname))
    ...
    oAria: { sSortAscending: ": Activar para ordenar la columna de manera ascendente", sSortDescending: ": Activar para ordenar la columna de manera descendente" }, oPaginate: { sFirst: "Primero", sLast: "Ãšltimo", sNext: "Siguiente", sPrevious: "Anterior" },
    sEmptyTable: "Ningun dato disponible en esta tabla", sInfo: "Mostrando  _START_ - _END_ de _TOTAL_ ", sInfoEmpty: "Mostrando  0 - 0 de 0 ", sInfoFiltered: "((filtrado de un total de _MAX_ registros))", sInfoPostFix: "", sDecimal: ".", sThousands: ",", sLengthMenu: "Mostrar _MENU_ registros", sLoadingRecords: "Cargando...", sProcessing: "Procesando...", sSearch: "Buscar :", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "No se encontraron resultados"
}, oSearch: h.extend({},
